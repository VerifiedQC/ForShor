import FastMultiplication.ShorVerification.AbstractMachine.QFTLoweringCorrectness.PlanSemantics
...
/--
The canonical plan obtained by splitting the inactive portion of `r`.
-/
