import FastMultiplication.ShorVerification.AbstractMachine.PhaseProductLoweringCorrectness.Linearity
...
/-- Allocation evaluates to an encoded target state whose child recursive reserves are clean. -/
